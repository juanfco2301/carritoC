...
<?php echo Form::open(['route'=>['users.update',$user],'method'=> 'PUT']); ?>
  ...
  <div class="from-group">
    ...
    <?php echo Form::text('name',$user->name,['class'=>'form-control','placeholder'=>'Nombres','required']); ?>

  </div>
  <div class="from-group">
    <?php echo Form::label('email','Correo Electronico'); ?>

    <?php echo Form::email('email',$user->email,['class'=>'form-control','placeholder'=>'Correo','required']); ?>
